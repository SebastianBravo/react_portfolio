...
function HeroSection() {
  ...
  const onDownload = () => {
    ...
    link.href =
      "https://sebastianbravo.github.io/react_portfolio/assets/CV_Juan_Sebastian_Bravo_Santacruz-3a57eb03.pdf";
        ...
        <Grid item xs={12} md={8}>
          ...
          <Box sx={{ mt: 2 }}>
            <Typography variant="body1" fontFamily="Rubik">
              ...
              TensorFlow, scikit-learn, and PyTorch for machine learning and
              deep learning projects. Completed projects involving generative AI
              and LLM on Azure, and ETLs using SQL and PySpark in Databricks.
            </Typography>
          </Box>
          <Box sx={{ mt: 2 }}>
            <Button
