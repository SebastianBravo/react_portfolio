        ...
        <Grid container spacing={2} sx={{ p: 3 }}>
          {languages.map((language, index) => (
            <Grid item xs={12} key={index}>
              <Box>
                <Typography variant="body2" sx={{ fontFamily: "Rubik", mb: 1 }}>
                  {language.name}
                </Typography>
          ...
          {libraries.map((library, index) => (
            <Grid item xs={4} key={index}>
              <Box>
                ...
                <LinearProgress variant="determinate" value={library.level} />
              </Box>
            </Grid>
          ))}
        </Grid>
          ...
          {tools.map((tool, index) => (
            <Grid item xs={4} key={index}>
              <Box>
                ...
                <LinearProgress variant="determinate" value={tool.level} />
              </Box>
            </Grid>
          ))}
        </Grid>
          ...
          {clouds.map((cloud, index) => (
            <Grid item xs={12} key={index}>
              <Box>
                ...
                <LinearProgress variant="determinate" value={cloud.level} />
              </Box>
            </Grid>
          ))}
        </Grid>
